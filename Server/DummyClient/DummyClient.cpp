...
#include "SocketUtils.h" // Added for SocketUtils

using namespace std;
using namespace std::chrono; // Add this namespace for duration literals like 1s

int main()
{
   SocketUtils::Init();

   this_thread::sleep_for(1s); // This will now work correctly
