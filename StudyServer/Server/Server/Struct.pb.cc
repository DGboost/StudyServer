...
PROTOBUF_CONSTEXPR ObjectInfo::ObjectInfo(
  ...
  , /*decltype(_impl_.worldx_)*/0
  , /*decltype(_impl_.worldy_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::ObjectInfo, _impl_.worldx_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ObjectInfo, _impl_.worldy_),
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\002\022\017\n\007victims\030\003 \003(\004\"\234\002\n\nObjectInfo\022\020\n\010"
  ...
  "worldX\030\014 \001(\002\022\016\n\006worldY\030\r \001(\002b\006proto3"
  ;
...
ObjectInfo::ObjectInfo(const ObjectInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.worldx_){}
    , decltype(_impl_.worldy_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.objectid_, &from._impl_.objectid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.worldy_) -
    reinterpret_cast<char*>(&_impl_.objectid_)) + sizeof(_impl_.worldy_));
...
// @@protoc_insertion_point(message_clear_start:Protocol.ObjectInfo)
  ...
  ::memset(&_impl_.objectid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.worldy_) -
      reinterpret_cast<char*>(&_impl_.objectid_)) + sizeof(_impl_.worldy_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 101)) {
          _impl_.worldx_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 109)) {
          _impl_.worldy_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ObjectInfo::_InternalSerialize(
  ...
  // float worldX = 12;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_worldx = this->_internal_worldx();
  uint32_t raw_worldx;
  memcpy(&raw_worldx, &tmp_worldx, sizeof(tmp_worldx));
  if (raw_worldx != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(12, this->_internal_worldx(), target);
  }

  // float worldY = 13;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_worldy = this->_internal_worldy();
  uint32_t raw_worldy;
  memcpy(&raw_worldy, &tmp_worldy, sizeof(tmp_worldy));
  if (raw_worldy != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(13, this->_internal_worldy(), target);
  }
...
void ObjectInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_worldx = from._internal_worldx();
  uint32_t raw_worldx;
  memcpy(&raw_worldx, &tmp_worldx, sizeof(tmp_worldx));
  if (raw_worldx != 0) {
    _this->_internal_set_worldx(from._internal_worldx());
  }
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_worldy = from._internal_worldy();
  uint32_t raw_worldy;
  memcpy(&raw_worldy, &tmp_worldy, sizeof(tmp_worldy));
  if (raw_worldy != 0) {
    _this->_internal_set_worldy(from._internal_worldy());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void ObjectInfo::InternalSwap(ObjectInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ObjectInfo, _impl_.worldy_)
      + sizeof(ObjectInfo::_impl_.worldy_)
